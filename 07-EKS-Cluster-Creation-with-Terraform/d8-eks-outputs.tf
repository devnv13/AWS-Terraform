...
output "cluster_arn" {
  description = "Amazon Resource Name of EKS Cluster"
  value = aws_eks_cluster.eks_cluster.arn
}

output "cluster_certificate_authority_data" {
  description = "Nested attribute containing certificate-authority-data of EKS Cluster. This is the base64 encoded certificate data required to communicate with your cluster."
...
output "cluster_version" {
  description = "Kubernetes Server Version of EKS Cluster"
  value = aws_eks_cluster.eks_cluster.version
}

output "cluster_iam_role_arn" {
  description = "IAM role ARN name of EKS Cluster"
